...
console.log('Promise', await handle(promise(Promise.resolve(10), Promise.resolve(10))));
console.log('Generators', await genRunner(gen(Promise.resolve(10), Promise.resolve(10))));
